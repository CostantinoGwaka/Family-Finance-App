...
class AddIncomeScreen extends StatelessWidget {
  ...
  AddIncomeScreen({this.dbManager}) {
    if (dbManager != null) {
      ...
      child: SafeArea(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0.25,
            backgroundColor: Color(0xfff5f6fa),
            // Here we take the value from the MyAddIncomeScreen object that was created by
            // the App.build method, and use it to set our appbar title.
            title: Text(
              "${this.dbManager != null ? 'Update' : 'New'} Income",
              style: TextStyle(
