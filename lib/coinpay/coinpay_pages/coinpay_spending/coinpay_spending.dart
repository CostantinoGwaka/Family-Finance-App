...
class CoinpaySpending extends StatefulWidget {
  const CoinpaySpending({Key? key}) : super(key: key);
...
class _CoinpaySpendingState extends State<CoinpaySpending> {
  ...
  List<String> categoryimg = [CoinpayPngimage.creditcard,CoinpayPngimage.incomeimg,CoinpayPngimage.bills,CoinpayPngimage.moneybag];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Spending".tr,style: pmedium.copyWith(fontSize: 18),),
      ),
          ...
          child: Column(
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Icon(Icons.keyboard_arrow_down,size: 20,color: CoinpayColor.black)
                    ],
                  ),
                ),
              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [  
                              Image.asset(CoinpayPngimage.creditcard,height: height/46,color: CoinpayColor.white,),
                              SizedBox(width: width/66,),
                              Text(
                                "Total_Spend".tr,
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Image.asset(CoinpayPngimage.creditcard,height: height/46,color: CoinpayColor.black,),
                              SizedBox(width: width/66,),
                              Text(
              ...
              Container(
                ...
                child: Image.asset(CoinpayPngimage.spendingchat,fit: BoxFit.fill,),
              ),
              SizedBox(height: height/36,),
              Container(
                height: height/7,
                         ...
                         child: Column(
                           ...
                           children: [
                             CircleAvatar(
                               ...
                               child: Image.asset(categoryimg[index],height: height/36,color: categorycolor[index],),
                             ),
                             SizedBox(height: height/96,),
                             Text(category[index].toString(),style: pregular.copyWith(
                                 fontSize: 12,color:selected == index ? categorycolor[index] : CoinpayColor.grey ),),
                             if(selected == index)...[
                               SizedBox(height: height/96,),
                               CircleAvatar(
                                radius: 3,
              ...
              if(selected == 0)...[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Spending_list".tr,style: psemiBold.copyWith(fontSize: 18),),
                    ...
                    return Row(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(spendinglist[index].toString(),style: pmedium.copyWith(fontSize: 15),),
                            Text("1st Jan at 7:20pm",style: pregular.copyWith(fontSize: 12),),
                          ],
                        ),
                        const Spacer(),
                        Text("-\$15.99",style: psemiBold.copyWith(fontSize: 14,color: CoinpayColor.red),),
