...
import '../../coinpay_dashboard/coinpay_dashboard.dart';
...
class CoinpayLogin extends StatefulWidget {
  const CoinpayLogin({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Password",style: psemiBold.copyWith(fontSize: 14,),),
            SizedBox(height: height/65,),
            TextField(
            ...
            SizedBox(height: height/56,),
            Text("Forgot password?",style: psemiBold.copyWith(fontSize: 12,color: CoinpayColor.appcolor),),
