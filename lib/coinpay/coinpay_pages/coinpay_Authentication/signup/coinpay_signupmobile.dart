...
class CoinpaySignupMobile extends StatefulWidget {
  const CoinpaySignupMobile({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Create a Account",style: psemiBold.copyWith(fontSize: 20,),),
            SizedBox(height: height/120,),
            Text("Enter your mobile number to verify your account",style: pregular.copyWith(fontSize: 12,color: CoinpayColor.textgray),),
            SizedBox(height: height/36,),
            Text("Phone",style: psemiBold.copyWith(fontSize: 14,),),
                  ...
                  child: Padding(
                    ...
                    child:  Column(
                      children: [
                        ...
                        Image.asset(CoinpayPngimage.verifyicon,height: height/6,fit: BoxFit.fitHeight,),
                        SizedBox(height: height/96,),
                        Text(
                          "Verify your phone number before we send code",maxLines: 2,overflow: TextOverflow.ellipsis,textAlign: TextAlign.center,
                          style: pmedium.copyWith(
                              fontSize: 18,),
                        ),
                        SizedBox(height: height/120,),
