...
class CoinpayHomeaddress extends StatefulWidget {
  const CoinpayHomeaddress({Key? key}) : super(key: key);
    ...
    child: const Icon(Icons.chevron_left,size: 30)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Home address",style: psemiBold.copyWith(fontSize: 20,),),
            ...
            Text("Address Line",style: psemiBold.copyWith(fontSize: 14,),),
            ...
            Text("City",style: psemiBold.copyWith(fontSize: 14,),),
            SizedBox(height: height/65,),
            TextField(
              style: pmedium.copyWith(fontSize: 14),
              decoration: InputDecoration(
            ...
            SizedBox(height: height/56,),
            Text("Postcode",style: psemiBold.copyWith(fontSize: 14,),),
            SizedBox(height: height/65,),
            TextField(
              style: pmedium.copyWith(fontSize: 14),
              decoration: InputDecoration(
