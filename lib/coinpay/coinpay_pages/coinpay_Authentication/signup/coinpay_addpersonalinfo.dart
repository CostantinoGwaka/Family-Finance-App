...
import 'coinpay_countryresidence.dart';


class CoinpayAddPersonalInfo extends StatefulWidget {
  const CoinpayAddPersonalInfo({Key? key}) : super(key: key);
    ...
    child: const Icon(Icons.chevron_left,size: 30)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Add your personal info",style: psemiBold.copyWith(fontSize: 20,),),
            ...
            Text("Full Name",style: psemiBold.copyWith(fontSize: 14,),),
            ...
            Text("Username",style: psemiBold.copyWith(fontSize: 14,),),
            SizedBox(height: height/65,),
            TextField(
              style: pmedium.copyWith(fontSize: 14),
              decoration: InputDecoration(
            ...
            SizedBox(height: height/56,),
            Text("Date of Birth",style: psemiBold.copyWith(fontSize: 14,),),
            SizedBox(height: height/65,),
            InkWell(
              onTap: () {
                aleartdialogdate();
    ...
    return showDialog(context: context, builder: (context) =>
        AlertDialog(
          title: Center(
            child: Column(
              children: [
                Text("Date of Birth",style: psemiBold.copyWith(fontSize: 16,)),
