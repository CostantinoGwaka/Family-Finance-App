...
class CoinpaySendMoney extends StatefulWidget {
  const CoinpaySendMoney({Key? key}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Image.asset(CoinpayPngimage.usaflag,height: height/30),
                          SizedBox(width: width/56,),
                           Icon(Icons.keyboard_arrow_down_rounded,size: 22,color: themedata.isdark?CoinpayColor.white:CoinpayColor.black,)
                        ],
                      ),
                      SizedBox(height: height/96,),
                      Center(
