...
class CoinpayChooseAccount extends StatefulWidget {
  const CoinpayChooseAccount({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Choose Account",style: pregular.copyWith(fontSize: 16),),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              Icon(isselected1 == index ?Icons.radio_button_checked_outlined:Icons.radio_button_unchecked,size: 25,color: isselected1 == index ?CoinpayColor.appcolor:CoinpayColor.bggray,)
                            ],
                          ),
                        ),
                    ),
